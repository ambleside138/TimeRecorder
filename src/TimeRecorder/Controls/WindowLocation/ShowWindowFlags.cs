...
{
	// 引用元
	// https://github.com/Grabacr07/MetroRadiance/blob/develop/source/MetroRadiance.Core/Interop/Win32/ShowWindowFlags.cs
	...
	public enum SW
	{
		...
		/// <summary>
		/// アプリケーションを起動したプログラムが 関数に渡した 構造体で指定された  フラグに従って表示状態を設定します。
		/// </summary>
		SHOWDEFAULT = 10,
	}
}
